...
#define MOTHERBOARD 1  // Adafruit Motor Shield 2
...
#define PEN_UP_ANGLE    (255)
#define PEN_DOWN_ANGLE  (0)  // Some servos don't like 0 degrees
#define PEN_DELAY       (0)  // in ms
...
static void setPenAngle(int pen_angle) {
  if(posz!=pen_angle) {
    ...
    //s1.write( (int)posz );
    analogWrite(SERVO_PIN, (int)posz);
    delay(PEN_DELAY);
  }
}
